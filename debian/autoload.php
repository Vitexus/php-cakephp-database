...
require_once '/usr/share/php/Cake/Chronos/autoload.php';
require_once '/usr/share/php/Cake/Datasource/autoload.php';
require_once '/usr/share/php/Psr/Log/autoload.php';

spl_autoload_register(function (string $class): void {
    $prefix = 'Cake\\Database\\';
    if (str_starts_with($class, $prefix)) {
        $file = '/usr/share/php/Cake/Database/' . str_replace('\\', '/', substr($class, strlen($prefix))) . '.php';
        if (file_exists($file)) {
            require $file;
        }
    }
